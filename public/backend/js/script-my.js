...
var gallery_row = 0;
  $("#rowAdder").click(function () {
    ...
    html += '<td  class="text-left"><a class="button-delete" onclick="$(\'#gallery-row' + gallery_row + '\').remove();" data-toggle="tooltip" title="Gỡ bỏ">';
    ...
    html += '<input type="file" name="gallery[]" class="d-block gallery-' + gallery_row + '" onchange="previewGalleryImage(event, ' + gallery_row + ')" />';
    html += '<img class="img-thumbnail gallery-preview mt-2" id="galleryPreview' + gallery_row + '" src="#" alt="Ảnh xem trước">';
    html += '</td>';
    html += '</tr>';
