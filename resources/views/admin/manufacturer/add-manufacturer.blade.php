...
@section('content')
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <button type="submit" form="add-manufacturer" class="button-add" title="Lưu thương hiệu">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.save-manufacturer') }}" id="add-manufacturer" class="form-manufacturer"
                            enctype="multipart/form-data" onsubmit="return validateFormManufacturerAdd()">
                            @csrf
